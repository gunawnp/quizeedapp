...
Route::get('/quiz_general/{qg_id}/{id}', [QuizGeneralController::class, 'show'])->middleware('isLogin');
Route::post('/quiz_general_detail', [QuizGeneralController::class, 'store_detail'])->middleware('isLogin');
Route::delete('/quiz_general_detail/{qg_id}/{id}', [QuizGeneralController::class, 'delete_detail'])->middleware('isLogin');
